...
void exampleWorld3(world *newworld)
{
    ...
    for (i = 0; i < TABLESIZE; i++)
    {
        ...
        {
            if (
                ((i == 0) && (j == 4)) || ((i == 0) && (j == 5)) || ((i == 4) && (j == 0)) || ((i == 5) && (j == 0)) || ((i == 9) && (j == 4)) || ((i == 9) && (j == 5)) || ((i == 4) && (j == 9)) || ((i == 5) && (j == 9)) || ((i == 1) && (j == 3)) || ((i == 2) && (j == 3)) || ((i == 3) && (j == 3)) || ((i == 1) && (j == 6)) || ((i == 2) && (j == 6)) || ((i == 3) && (j == 6)) || ((i == 2) && (j == 4)) || ((i == 2) && (j == 5)) || ((i == 3) && (j == 1)) || ((i == 6) && (j == 1)) || ((i == 3) && (j == 8)) || ((i == 6) && (j == 8)) || ((i == 6) && (j == 3)) || ((i == 6) && (j == 6)) || ((i == 7) && (j == 3)) || ((i == 7) && (j == 6)) || ((i == 7) && (j == 4)) || ((i == 7) && (j == 5)) || ((i == 8) && (j == 3)) || ((i == 8) && (j == 6)))
            {
                newworld->table[i][j] = 48;
            }
            else
...
void newGen(world *thisGen, int *counter)
{
    ...
    for (i = 0; i < TABLESIZE; i++)
    {
        for (j = 0; j < TABLESIZE; j++)
        {
            ...
            {
                if ((thisGen->table[i - 1][j - 1] == 43 || thisGen->table[i - 1][j - 1] == 48) && (i - 1) >= 0 && (j - 1) >= 0)
                {
                    checkSum++;
                }
                if ((thisGen->table[i - 1][j] == 43 || thisGen->table[i - 1][j] == 48) && (i - 1) >= 0)
                {
                    checkSum++;
                }
                if ((thisGen->table[i - 1][j + 1] == 43 || thisGen->table[i - 1][j + 1] == 48) && (i - 1) >= 0 && (j + 1) < TABLESIZE)
                {
                    checkSum++;
                }
                if ((thisGen->table[i][j - 1] == 43 || thisGen->table[i][j - 1] == 48) && (j - 1) >= 0)
                {
                    checkSum++;
                }
                if ((thisGen->table[i][j + 1] == 43 || thisGen->table[i][j + 1] == 48) && (j + 1) < TABLESIZE)
                {
                    checkSum++;
                }
                if ((thisGen->table[i + 1][j - 1] == 43 || thisGen->table[i + 1][j - 1] == 48) && (j - 1) >= 0 && (i + 1) < TABLESIZE)
                {
                    checkSum++;
                }
                if ((thisGen->table[i + 1][j] == 43 || thisGen->table[i + 1][j] == 48) && (i + 1) < TABLESIZE)
                {
                    checkSum++;
                }
                if ((thisGen->table[i + 1][j + 1] == 43 || thisGen->table[i + 1][j + 1] == 48) && (i + 1) < TABLESIZE && (j + 1) < TABLESIZE)
                {
                    checkSum++;
                }
                //printf("deads : %d \n", checkSum);//Debug only
                if (checkSum == 3)
                {
                    nextGen.table[i][j] = 48;
                } //dead to newborn
                else
                {
                    nextGen.table[i][j] = 45;
                }
                checkSum = 0;
            }
            else if (thisGen->table[i][j] == 43 || thisGen->table[i][j] == 48) //if cell is alive or newborn
            {
                ...
                if ((thisGen->table[i + 1][j + 1] == 43 || thisGen->table[i + 1][j + 1] == 48) && (i + 1) < 10 && (j + 1) < TABLESIZE)
                {
                    checkSum++;
                }
                //printf("alives : %d \n", checkSum); //debug only
                ...
                {
                    nextGen.table[i][j] = 43;
                } //cell stays alive or newborn to alive
                else
                {
                    nextGen.table[i][j] = thisGen->table[i][j];
                }
                checkSum = 0;
            }
            else
